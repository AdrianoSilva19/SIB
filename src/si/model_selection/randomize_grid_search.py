...
def randomized_search_cv(model, dataset: Dataset, parameter_distribution: Union[Dict, List[Dict]],
                         scoring: Callable = None, cv: int = 3, test_size: float = 0.2, n_iter: int = 10):
